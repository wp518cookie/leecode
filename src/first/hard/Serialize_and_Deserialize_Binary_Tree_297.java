...
//        treeNode1.left = treeNode2;
    ...
    // Encodes a first.tree to a single string.
    public static String serialize(TreeNode root) {
        ...
        while (!queue.isEmpty()) {
            ...
            sb.append(temp == null ? "null," : String.valueOf(temp.val) + ",");
            if (temp != null) {
...
//        String[] pre_result = sb.toString().substring(0, sb.length() - 1).split(",");
//        int j = 0;
//        for (int i = pre_result.length - 1; i > 0; i--) {
//            if (pre_result[i].equals("null")) {
//                j++;
//            } else {
//                break;
//            }
...
//        for (int i = 0; i < pre_result.length - j; i++) {
//            sb1.append(pre_result[i]);
//            if (i != pre_result.length - j - 1) {
//                sb1.append(",");
//            }
//        }
        return sb.toString();
    ...
    // Decodes your encoded data to first.tree.
    public static TreeNode deserialize(String data) {
        ...
        while (i < length) {
            ...
            if (temp != null) {
                String temp_left = arr[i++];
                if (temp_left.equals("null")) {
                    temp.left = null;
                } else {
                    temp.left = new TreeNode(Integer.valueOf(temp_left));
                }
                nodeQueue.offer(temp.left);
                if (i < length) {
                    String temp_right = arr[i++];
                    if (temp_right.equals("null")) {
                        temp.right = null;
                    } else {
                        temp.right = new TreeNode(Integer.valueOf(temp_right));
                    }
