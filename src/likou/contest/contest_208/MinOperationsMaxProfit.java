...
public class MinOperationsMaxProfit {
    public static void main(String[] args) {
        new MinOperationsMaxProfit().minOperationsMaxProfit(new int[]{8, 3}, 5, 6);
    }
    public int minOperationsMaxProfit(int[] customers, int boardingCost, int runningCost) {
        ...
        for (int i = 0; i < customers.length; i++) {
            ...
            int temp = restCustomers >= 4 ? 4 : restCustomers;
            restCustomers = restCustomers - temp;
            int profitTemp = boardingCost * temp - runningCost;
            restProfit = restProfit + profitTemp;
            profit.add(restProfit);
        }
